        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link mx-2 active" aria-current="page" href="../vistas/inicio.php">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2 active" aria-current="page" href="../vistas/otorgarprestamos.php">Otorgar Prestamo</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2 active" href="./src/controlador/cerrarsesion.php">Salir</a>
                    </li>
                </ul>
            </div>
        </div>
